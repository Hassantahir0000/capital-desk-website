    ...
    <div className="bg-[#f5f5f5] min-h-screen w-full overflow-x-hidden">
      ...
      <section id="home" className="relative px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 lg:pt-32 pb-24 sm:pb-32 lg:pb-48">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="font-['Faktum_Test'] text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight text-[#1a3347] tracking-tight mb-4 sm:mb-6 px-4">
            The Capital Desk Underwriting Calculator is launching in beta
          </h1>
          <p className="font-['Inter'] text-lg sm:text-xl md:text-2xl text-[#444] leading-relaxed max-w-4xl mx-auto mb-8 sm:mb-12 px-4">
          ...
          {/* CTA Buttons */}
          <div id="beta" className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 sm:mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative order-2 lg:order-1">
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#007BDA] to-black p-8 sm:p-12">
                ...
                <div className="absolute top-8 right-8 bg-white rounded-2xl p-4 shadow-xl max-w-[200px]">
      ...
      <section id="how-it-works" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-['Faktum_Test'] text-3xl sm:text-4xl lg:text-5xl text-center bg-gradient-to-b from-[#0e5575] to-[#043a53] bg-clip-text text-transparent mb-12 sm:mb-16">
            How It Works
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {/* Feature 1 */}
            <div className="bg-white border border-[#d8d8d8] rounded-2xl p-6 sm:p-8 hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="font-['Faktum_Test'] text-3xl sm:text-4xl lg:text-5xl text-[#007bda] mb-4">
            Built for the teams moving deals forward
          </h2>
          <p className="font-['Inter'] text-lg sm:text-xl md:text-2xl text-[#444] max-w-4xl mx-auto mb-12 sm:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <div key={index} className="border border-dashed border-[rgba(0,0,0,0.28)] rounded-2xl p-6 sm:p-8 hover:border-[#007BDA] transition-colors">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              "What does the Underwriting Calculator help with?",
              "Can I search for leads and create calculators?",
              "Can I model my own offers?",
              "Is this built for individual users or teams?",
              "What comes after the Underwriting Calculator?",
              "How do I get access?"
            ].map((question, index) => (
              <div key={index} className="border-b border-[#122038]/20 pb-6">
                <button
                  onClick={() => setOpenFaq(openFaq === index ? null : index)}
                  className="w-full flex items-center justify-between text-left group"
                >
                  <p className="font-['Inter'] text-xl sm:text-2xl lg:text-3xl text-[#122038] pr-4">
                    {question}
                  </p>
                  <div className={`flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 transition-transform ${openFaq === index ? 'rotate-90' : ''}`}>
